...
%plot_by_ND_forJB('cell', dataloc,'plottype',plottype,'channel',plotme,'looptime',1,'combinexys',true)

plot_by_ND_forJB('cell', dataloc,'plottype',plottype,'channel',plotme,'looptime',1,'combinexys',true,'font_size',9)
