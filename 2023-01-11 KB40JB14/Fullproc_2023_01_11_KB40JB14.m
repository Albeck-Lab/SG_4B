...
plot_by_ND_forJB('treatment', dataloc,'plottype',plottype,'channel',plotme,'looptime',2,'saveloc',dataloc.fold.fig)
plot_by_ND_forJB('cell', dataloc,'plottype',plottype,'channel',plotme,'looptime',2)
