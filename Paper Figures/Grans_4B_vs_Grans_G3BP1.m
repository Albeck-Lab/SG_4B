...
% Cant use opp data bc the opp reaction kills the 4b signal

basePath = '\\albecklab.mcb.ucdavis.edu\data\imageData\SG_4B\';

% 2023-05-03
dataset1 = load([basePath,'2023-05-03 4B-WT 4B-Mut Tet curve NaAsO2 curve\2023-05-03 4B-WT 4B-Mut Tet curve NaAsO2 curve_Processed.mat']);
dataset1 = dataset1.dataloc; % pull the loaded dataloc structure

% 202
% dataset2 = load('_Processed.mat');
...
%% 24 hour tet wt or F139A 4B Grans vs G3BP1 Grans at 125uM NaAsO2
minGrans = 3;
...
figure;
scatter(dataloc.ifd.Children_Grans_4B_Count(subz),dataloc.ifd.cell(subz),'Notch','on','Symbol','.','Colors',[0.3010, 0.7450, 0.9330; 0.6350, 0.0780, 0.1840])
