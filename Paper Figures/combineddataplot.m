...
plot_by_ND_forJB('treatment', datalocDF,'plottype',plottype,'channel',plotme,'looptime',3,'font_size',8,'tmaxaftertx',1,'saveloc','Z:\imageData\SG_4B\Paper Figures','closefigs',false,'exclude','washoff')
cFig = gcf;
...
save(cFig,'Z:\imageData\SG_4B\Paper_Figures\S2A.svg')
save(cFig,'Z:\imageData\SG_4B\Paper_Figures\S2A.fig')