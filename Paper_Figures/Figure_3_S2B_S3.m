...
% determine the difference there is btwn the wt and mut OPP at each NaAsO2 treatment concentration
% at 62.5uM mut - wt
...
% What is the % difference btwn the two groups?
percG3BP1change = ((G3BP1data{"125uM_mut","mean_Children_Grans_G3BP1_Count"} - G3BP1data{"125uM_wt","mean_Children_Grans_G3BP1_Count"})/G3BP1data{"125uM_mut","mean_Children_Grans_G3BP1_Count"})
...
saveas(figG3bp1,'Z:\imageData\SG_4B\Paper_Figures\Output_Figures\Figure_S2B_125uM_G3BP1.fig')
saveas(figG3bp1,'Z:\imageData\SG_4B\Paper_Figures\Output_Figures\Figure_S2B_125uM_G3BP1.svg')
