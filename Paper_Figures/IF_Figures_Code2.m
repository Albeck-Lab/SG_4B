...
% 
% 2023-06-29 Data
% 4B and opp data is good, g3bp1 stain is bad
...
% 2023-08-23 Data
% 4b, g3bp1, and opp look good, 
% xy 20,46, maybe 48? look bad in OPP
...
fourBstats = grpstats(dataloc.ifd(subz,:),"cell",["mean","median","sem","std","meanci"],"DataVars","Children_Grans_G3BP1_Count");

figure;
plt = bar(categorical(fourBstats.cell,["HeLa eIF4BGFP","HeLa 4B139AGFP"]),fourBstats.mean_Children_Grans_G3BP1_Count,1,"LineWidth",1);
hold on;
errorbar(categorical(fourBstats.cell,["HeLa eIF4BGFP","HeLa 4B139AGFP"]),fourBstats.mean_Children_Grans_G3BP1_Count,fourBstats.sem_Children_Grans_G3BP1_Count,"LineStyle","none","Color","k","LineWidth",1)
